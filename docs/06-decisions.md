...
| Écran de saisie des paramètres de l'immeuble (code de référence, gabarit, coordonnées bancaires, moyens de règlement) | Tant qu'il n'y a qu'un immeuble, ces colonnes se renseignent en SQL, comme le règlement (voir « Écran Nouvel immeuble »). Le compte du syndicat n'existe pas encore. | Le compte bancaire ouvert (question n° 1), ou le deuxième immeuble. |
